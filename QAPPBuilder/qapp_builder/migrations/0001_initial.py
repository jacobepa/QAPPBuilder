    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='sectiona',
            name='a1',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona1'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a10',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona10'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a11',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona11'),
        ),
        migrations.CreateModel(
            name='SectionA12',
            fields=[
        ...
        migrations.AddField(
            model_name='sectiona',
            name='a12',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona12'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a2',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona2'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a4',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona4'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a5',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona5'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a6',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona6'),
        ),
        migrations.CreateModel(
            name='SectionA7',
            fields=[
        ...
        migrations.AddField(
            model_name='sectiona',
            name='a7',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona7'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a8',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona8'),
        ),
        migrations.AddField(
            model_name='sectiona',
            name='a9',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qapp_builder.sectiona9'),
        ),
    ]
