SECTION_C = {
    ...
    'c1_1': {
        ...
        'boilerplate_a': '''
            For QA Category A projects, at least one project-specific audit will
            be performed in accordance with ORD QA Policy titled, Use of the
            Graded Approach for Quality Assurance of Research (PPM 13.07) to
            assess adherence of research activities to EPA and ORD quality
            policies and procedure and the project's QAPP. The QA Manager,
            Technical Lead and/or management have determined that an [indicate
            type of audit, see PPM 13.07 for applicable audit types] will be
            conducted by the QA Manager or designee. The audit will be conducted
            in accordance with the ORD QA Policy titled, Audits of Technical and
            Quality Systems (PPM 13.13). Any findings, observations, noteworthy
            best practices, or recommendations for improvement will be compiled
            in a report and filed with the project records.
        ...
        ''',
        'boilerplate_b': '''
            For QA Category B projects, QA audits are conducted at the
            discretion of management and/or the QAM. If a QA Audit is conducted,
            it will be in accordance with ORD QA Policy titled, Audits of
            Technical and Quality Systems (PPM 13.13). Any findings,
